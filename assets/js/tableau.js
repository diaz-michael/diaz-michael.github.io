(function() {
	...
	window.tableau._apiLoaded || (window.tableau._apiLoaded = !0, function() {
		...
		function yt(n) {
			for (var r, u, i = l(n), t = n.parentElement; t && t.parentElement; t = t.parentElement) r = f(t).overflow, (r === "auto" || r === "scroll" || r === "visible") && (i = it(i, l(t)));
			return u = vt(), it(i, u)
		}
